...
train_file = train_path + 'preprocess_stride_6_test_dcms_smooth_gt/train.p'
train_train_file = train_path + 'preprocess_stride_6_test_dcms_smooth_gt/train_train.p'
train_val_file = train_path + 'preprocess_stride_6_test_dcms_smooth_gt/train_val.p'
test_files = [test_path + 'preprocess_stride_6_test_dcms_smooth_gt/test_1.p', 
              test_path + 'preprocess_stride_6_test_dcms_smooth_gt/test_2.p', 
              test_path + 'preprocess_stride_6_test_dcms_smooth_gt/test_3.p', 
              test_path + 'preprocess_stride_6_test_dcms_smooth_gt/test_4.p', 
              test_path + 'preprocess_stride_6_test_dcms_smooth_gt/test_5.p', 
              test_path + 'preprocess_stride_6_test_dcms_smooth_gt/test_6.p', 
              test_path + 'preprocess_stride_6_test_dcms_smooth_gt/test_7.p', 
              test_path + 'preprocess_stride_6_test_dcms_smooth_gt/test_8.p', 
             ]

vis_path = "/mnt/home/data/giga2024/Trajectory/vis/"

def gaussian_smoothing(data, sigma=10):
            ...
            for i in tqdm(range(num_scene)):
                ...
                for agent_current_step in range(start_index, agent_steps[-1], 6):
                    ...
                    for traj, step, pred_id in zip(trajs, steps, scene_pred_ids):
                        ...
                        future_traj = gaussian_smoothing(future_traj)
                        if vis_count < 10:
        ...
        with open(file) as f:
            ...
            for i in tqdm(range(num_scene)):
                ...
                for traj, step, pred_id in zip(trajs, steps, scene_pred_ids):
                    ...
                    origin_past_ctr[step_curr, 2] = 1.0
