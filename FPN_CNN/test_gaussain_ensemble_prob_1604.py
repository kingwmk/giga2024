...
parser.add_argument(
    "--weight1", default="1.604.ckpt", type=str, metavar="WEIGHT", help="checkpoint path"
)
...
parser.add_argument(
    "--weight3", default="1.604.ckpt", type=str, metavar="WEIGHT", help="checkpoint path"
)
...
parser.add_argument(
    "--weight5", default="1.604.ckpt", type=str, metavar="WEIGHT", help="checkpoint path"
)
...
parser.add_argument(
    "--weight7", default="1.604.ckpt", type=str, metavar="WEIGHT", help="checkpoint path"
)
...
parser.add_argument(
    "--weight9", default="1.604.ckpt", type=str, metavar="WEIGHT", help="checkpoint path"
)
...
parser.add_argument(
    "--weight11", default="1.604.ckpt", type=str, metavar="WEIGHT", help="checkpoint path"
)
...
parser.add_argument(
    "--weight13", default="1.604.ckpt", type=str, metavar="WEIGHT", help="checkpoint path"
)
...
parser.add_argument(
    "--weight15", default="1.604.ckpt", type=str, metavar="WEIGHT", help="checkpoint path"
)
...
parser.add_argument(
    "--weight17", default="1.604.ckpt", type=str, metavar="WEIGHT", help="checkpoint path"
)
...
parser.add_argument(
    "--weight19", default="1.604.ckpt", type=str, metavar="WEIGHT", help="checkpoint path"
)
...
output_files = ['submission/1604_gaussain_prob/test_1.ndjson',
                'submission/1604_gaussain_prob/test_2.ndjson',
                'submission/1604_gaussain_prob/test_3.ndjson', 
                'submission/1604_gaussain_prob/test_4.ndjson',
                'submission/1604_gaussain_prob/test_5.ndjson', 
                'submission/1604_gaussain_prob/test_6.ndjson',
                'submission/1604_gaussain_prob/test_7.ndjson', 
                'submission/1604_gaussain_prob/test_8.ndjson',
               ]
