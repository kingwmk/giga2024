...
train_file = train_path + 'preprocess_light_stride_4_test_2d_dcms/train.p'
train_train_file = train_path + 'preprocess_light_stride_4_test_2d_dcms/train_train.p'
train_val_file = train_path + 'preprocess_light_stride_4_test_2d_dcms/train_val.p'
test_files = [test_path + 'preprocess_light_stride_4_test_2d_dcms/test_1.p', 
              test_path + 'preprocess_light_stride_4_test_2d_dcms/test_2.p', 
              test_path + 'preprocess_light_stride_4_test_2d_dcms/test_3.p', 
              test_path + 'preprocess_light_stride_4_test_2d_dcms/test_4.p', 
              test_path + 'preprocess_light_stride_4_test_2d_dcms/test_5.p', 
              test_path + 'preprocess_light_stride_4_test_2d_dcms/test_6.p', 
              test_path + 'preprocess_light_stride_4_test_2d_dcms/test_7.p', 
              test_path + 'preprocess_light_stride_4_test_2d_dcms/test_8.p', 
             ]
    ...
    for f_idx, file in enumerate(train_set):
        ...
        with open(file) as f:
            ...
            for i in tqdm(range(num_scene)):
                ...
                for agent_current_step in range(1, agent_steps[-1], 4):
                    ...
                    if (agent_current_step not in agent_steps) or ((agent_current_step-1) not in agent_steps
                                                            ) or ((agent_current_step+1) not in agent_steps):
                        continue
