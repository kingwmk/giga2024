...
train_file = train_path + 'preprocess_stride_6_test_dcms_r50/train.p'
train_train_file = train_path + 'preprocess_stride_6_test_dcms_r50/train_train.p'
train_val_file = train_path + 'preprocess_stride_6_test_dcms_r50/train_val.p'
test_files = [test_path + 'preprocess_stride_6_test_dcms_r50/test_1.p', 
              test_path + 'preprocess_stride_6_test_dcms_r50/test_2.p', 
              test_path + 'preprocess_stride_6_test_dcms_r50/test_3.p', 
              test_path + 'preprocess_stride_6_test_dcms_r50/test_4.p', 
              test_path + 'preprocess_stride_6_test_dcms_r50/test_5.p', 
              test_path + 'preprocess_stride_6_test_dcms_r50/test_6.p', 
              test_path + 'preprocess_stride_6_test_dcms_r50/test_7.p', 
              test_path + 'preprocess_stride_6_test_dcms_r50/test_8.p', 
             ]

vis_path = "/mnt/home/data/giga2024/Trajectory/vis/"
pred_range = [-25.0, 25.0, -25.0, 25.0]
