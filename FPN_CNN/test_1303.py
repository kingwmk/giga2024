...
parser.add_argument(
    "--weight1", default="1.303.ckpt", type=str, metavar="WEIGHT", help="checkpoint path"
)
...
parser.add_argument(
    "--weight3", default="1.303.ckpt", type=str, metavar="WEIGHT", help="checkpoint path"
)
...
parser.add_argument(
    "--weight5", default="1.303.ckpt", type=str, metavar="WEIGHT", help="checkpoint path"
)
...
parser.add_argument(
    "--weight7", default="1.303.ckpt", type=str, metavar="WEIGHT", help="checkpoint path"
)
...
parser.add_argument(
    "--weight9", default="1.303.ckpt", type=str, metavar="WEIGHT", help="checkpoint path"
)
...
parser.add_argument(
    "--weight11", default="1.303.ckpt", type=str, metavar="WEIGHT", help="checkpoint path"
)
...
parser.add_argument(
    "--weight13", default="1.303.ckpt", type=str, metavar="WEIGHT", help="checkpoint path"
)
...
parser.add_argument(
    "--weight15", default="1.303.ckpt", type=str, metavar="WEIGHT", help="checkpoint path"
)
...
parser.add_argument(
    "--weight17", default="1.303.ckpt", type=str, metavar="WEIGHT", help="checkpoint path"
)
...
parser.add_argument(
    "--weight19", default="1.303.ckpt", type=str, metavar="WEIGHT", help="checkpoint path"
)
...
output_files = ['submission/1303/test_1.ndjson',
                'submission/1303/test_2.ndjson',
                'submission/1303/test_3.ndjson', 
                'submission/1303/test_4.ndjson',
                'submission/1303/test_5.ndjson', 
                'submission/1303/test_6.ndjson',
                'submission/1303/test_7.ndjson', 
                'submission/1303/test_8.ndjson',
               ]
