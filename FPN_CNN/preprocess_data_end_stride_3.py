...
train_file = train_path + 'preprocess_end_stride_3/train.p'
train_train_file = train_path + 'preprocess_end_stride_3/train_train.p'
train_val_file = train_path + 'preprocess_end_stride_3/train_val.p'
