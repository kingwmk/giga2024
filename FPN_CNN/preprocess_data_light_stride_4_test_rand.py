...
train_file = train_path + 'preprocess_light_stride_4_test_rand/train.p'
train_train_file = train_path + 'preprocess_light_stride_4_test_rand/train_train.p'
train_val_file = train_path + 'preprocess_light_stride_4_test_rand/train_val.p'
    ...
    for f_idx, file in enumerate(train_set):
        ...
        with open(file) as f:
            ...
            for i in tqdm(range(num_scene)):
                ...
                for agent_current_step in range(start_index, agent_steps[-1], 4):
