...
train_file = train_path + 'preprocess_stride_6_test_dcms_smooth/train.p'
train_train_file = train_path + 'preprocess_stride_6_test_dcms_smooth/train_train.p'
train_val_file = train_path + 'preprocess_stride_6_test_dcms_smooth/train_val.p'
test_files = [test_path + 'preprocess_stride_6_test_dcms_smooth/test_1.p', 
              test_path + 'preprocess_stride_6_test_dcms_smooth/test_2.p', 
              test_path + 'preprocess_stride_6_test_dcms_smooth/test_3.p', 
              test_path + 'preprocess_stride_6_test_dcms_smooth/test_4.p', 
              test_path + 'preprocess_stride_6_test_dcms_smooth/test_5.p', 
              test_path + 'preprocess_stride_6_test_dcms_smooth/test_6.p', 
              test_path + 'preprocess_stride_6_test_dcms_smooth/test_7.p', 
              test_path + 'preprocess_stride_6_test_dcms_smooth/test_8.p', 
             ]
