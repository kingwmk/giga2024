...
parser.add_argument(
    "-m1", "--model1", default="gigaNet_stride_6_test_rand_dcms", type=str, metavar="MODEL", help="model name"
)
parser.add_argument(
    "--weight1", default="2.407.ckpt", type=str, metavar="WEIGHT", help="checkpoint path"
)
parser.add_argument(
...
parser.add_argument(
    "--weight3", default="2.407.ckpt", type=str, metavar="WEIGHT", help="checkpoint path"
)
parser.add_argument(
...
parser.add_argument(
    "--weight5", default="2.407.ckpt", type=str, metavar="WEIGHT", help="checkpoint path"
)
parser.add_argument(
...
parser.add_argument(
    "--weight7", default="2.407.ckpt", type=str, metavar="WEIGHT", help="checkpoint path"
)
parser.add_argument(
...
parser.add_argument(
    "--weight9", default="2.407.ckpt", type=str, metavar="WEIGHT", help="checkpoint path"
)
parser.add_argument(
...
parser.add_argument(
    "--weight11", default="2.407.ckpt", type=str, metavar="WEIGHT", help="checkpoint path"
)
parser.add_argument(
...
parser.add_argument(
    "--weight13", default="2.407.ckpt", type=str, metavar="WEIGHT", help="checkpoint path"
)
parser.add_argument(
...
parser.add_argument(
    "--weight15", default="2.407.ckpt", type=str, metavar="WEIGHT", help="checkpoint path"
)
parser.add_argument(
...
parser.add_argument(
    "--weight17", default="2.407.ckpt", type=str, metavar="WEIGHT", help="checkpoint path"
)
parser.add_argument(
...
parser.add_argument(
    "--weight19", default="2.407.ckpt", type=str, metavar="WEIGHT", help="checkpoint path"
)
parser.add_argument(
    ...
    for f_idx in range(len(test_files)):
        ...
        for ii, data in tqdm(enumerate(data_loader)):
            ...
            with torch.no_grad():
                ...
                save[10].append((results10, cls10))
                ...
                save[11].append((results11, cls11))
                ...
                save[12].append((results12, cls12))
                ...
                save[13].append((results13, cls13))
                ...
                save[14].append((results14, cls14))
                ...
                save[15].append((results15, cls15))
                ...
                save[16].append((results16, cls16))
                ...
                save[17].append((results17, cls17))
                ...
                save[18].append((results18, cls18))
