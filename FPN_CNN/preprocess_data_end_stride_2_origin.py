...
train_file = train_path + 'preprocess_end_stride_2_origin/train.p'
train_train_file = train_path + 'preprocess_end_stride_2_origin/train_train.p'
train_val_file = train_path + 'preprocess_end_stride_2_origin/train_val.p'
        ...
        with open(file) as f:
            ...
            for i in tqdm(range(num_scene)):
                ...
                for agent_current_step in range(1, agent_steps[-1], 2):
                    ...
                    feats, ctrs, gt_preds, has_preds, valid_track_ids, origin_past_ctrs = [], [], [], [], [], []
                    ...
                    data['origin_past_ctrs'] = origin_past_ctrs
                    if has_preds[0] == True:
