...
train_files_path = "/mnt/home/data/giga2024/Trajectory/train/train_preprocess_files/"
...
class gigaDataset(Dataset):
    def __init__(self, processed_file_names):
        self.processed_file_names = processed_file_names
            
    def __getitem__(self, idx):
        with open(self.processed_file_names[idx], 'rb') as handle:  
