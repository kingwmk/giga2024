...
train_file = train_path + 'preprocess_stride_6_test_dcms/train.p'
train_train_file = train_path + 'preprocess_stride_6_test_dcms/train_train.p'
train_val_file = train_path + 'preprocess_stride_6_test_dcms/train_val.p'
test_files = [test_path + 'preprocess_stride_6_test_dcms/test_1.p', 
              test_path + 'preprocess_stride_6_test_dcms/test_2.p', 
              test_path + 'preprocess_stride_6_test_dcms/test_3.p', 
              test_path + 'preprocess_stride_6_test_dcms/test_4.p', 
              test_path + 'preprocess_stride_6_test_dcms/test_5.p', 
              test_path + 'preprocess_stride_6_test_dcms/test_6.p', 
              test_path + 'preprocess_stride_6_test_dcms/test_7.p', 
              test_path + 'preprocess_stride_6_test_dcms/test_8.p', 
             ]
