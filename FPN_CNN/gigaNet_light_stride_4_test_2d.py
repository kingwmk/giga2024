...
config["train_split"] = root_path + 'train/preprocess_light_stride_4_test_2d/train.p'
config["val_split"] = root_path + 'train/preprocess_light_stride_4_test_2d/train_val.p'
config["test_split"] = root_path + 'test/preprocess_light_stride_4_test_2d/test_1.p'
