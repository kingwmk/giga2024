...
config["train_split"] = root_path + 'train/preprocess_stride_6_test_dcms_smooth/train.p'
config["val_split"] = root_path + 'train/preprocess_stride_6_test_dcms_smooth/train_val.p'
config["test_split"] = root_path + 'test/preprocess_stride_6_test_dcms_smooth/test_1.p'
