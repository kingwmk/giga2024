...
train_file = train_path + 'preprocess_end_stride_2/train.p'
train_train_file = train_path + 'preprocess_end_stride_2/train_train.p'
train_val_file = train_path + 'preprocess_end_stride_2/train_val.p'
