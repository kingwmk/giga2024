...
train_file = train_path + 'preprocess_stride_6_test_dcms_r60/train.p'
train_train_file = train_path + 'preprocess_stride_6_test_dcms_r60/train_train.p'
train_val_file = train_path + 'preprocess_stride_6_test_dcms_r60/train_val.p'
test_files = [test_path + 'preprocess_stride_6_test_dcms_r60/test_1.p', 
              test_path + 'preprocess_stride_6_test_dcms_r60/test_2.p', 
              test_path + 'preprocess_stride_6_test_dcms_r60/test_3.p', 
              test_path + 'preprocess_stride_6_test_dcms_r60/test_4.p', 
              test_path + 'preprocess_stride_6_test_dcms_r60/test_5.p', 
              test_path + 'preprocess_stride_6_test_dcms_r60/test_6.p', 
              test_path + 'preprocess_stride_6_test_dcms_r60/test_7.p', 
              test_path + 'preprocess_stride_6_test_dcms_r60/test_8.p', 
             ]

vis_path = "/mnt/home/data/giga2024/Trajectory/vis/"
pred_range = [-30.0, 30.0, -30.0, 30.0]
