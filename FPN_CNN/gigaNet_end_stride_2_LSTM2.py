...
class ActorNet(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.lstm_encoder = nn.LSTM(n, n, num_layers=2, batch_first=True)
        self.dropout_lstm = nn.Dropout(0.1)
        self.dropout_cnn = nn.Dropout(0.1)
        self.output_lstm = LinearRes(n, n, norm=norm, ng=ng)
    ...
    def forward(self, actors: Tensor, actor_ctrs) -> Tensor:
        ...
        out_lstm = self.output_lstm(out_lstm)
