...
config["train_split"] = root_path + 'train/preprocess_light_stride_4_test_rand/train.p'
config["val_split"] = root_path + 'train/preprocess_light_stride_4_test_rand/train_val.p'
config["test_split"] = root_path + 'test/preprocess_light_stride_2/test_1.p'
