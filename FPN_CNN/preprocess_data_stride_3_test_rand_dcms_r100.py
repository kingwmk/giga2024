...
train_file = train_path + 'preprocess_stride_3_test_dcms_r100/train.p'
train_train_file = train_path + 'preprocess_stride_3_test_dcms_r100/train_train.p'
train_val_file = train_path + 'preprocess_stride_3_test_dcms_r100/train_val.p'
test_files = [test_path + 'preprocess_stride_3_test_dcms_r100/test_1.p', 
              test_path + 'preprocess_stride_3_test_dcms_r100/test_2.p', 
              test_path + 'preprocess_stride_3_test_dcms_r100/test_3.p', 
              test_path + 'preprocess_stride_3_test_dcms_r100/test_4.p', 
              test_path + 'preprocess_stride_3_test_dcms_r100/test_5.p', 
              test_path + 'preprocess_stride_3_test_dcms_r100/test_6.p', 
              test_path + 'preprocess_stride_3_test_dcms_r100/test_7.p', 
              test_path + 'preprocess_stride_3_test_dcms_r100/test_8.p', 
             ]

vis_path = "/mnt/home/data/giga2024/Trajectory/vis/"
pred_range = [-50.0, 50.0, -50.0, 50.0]
    ...
    for f_idx, file in enumerate(train_set):
        ...
        with open(file) as f:
            ...
            for i in tqdm(range(num_scene)):
                ...
                for agent_current_step in range(start_index, agent_steps[-1], 3):
