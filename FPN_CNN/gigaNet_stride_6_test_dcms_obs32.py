...
config["opt"] = "adam"
config["num_epochs"] = 3
config["start_val_epoch"] = 4
config["lr"] = [5e-4, 1e-4]
config["lr_epochs"] = [2.8,]
...
config["train_split"] = root_path + 'train/preprocess_stride_6_dcms_obs32/train.p'
config["val_split"] = root_path + 'train/preprocess_stride_6_dcms_obs32/train_val.p'
