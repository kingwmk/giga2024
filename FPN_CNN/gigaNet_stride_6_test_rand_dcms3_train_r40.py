...
config["train_split"] = root_path + 'train/preprocess_stride_6_test_dcms_r40/train.p'
config["val_split"] = root_path + 'train/preprocess_stride_6_test_dcms_r40/train_val.p'
