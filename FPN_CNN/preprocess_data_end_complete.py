...
train_file = train_path + 'preprocess_end_complete/train.p'
train_train_file = train_path + 'preprocess_end_complete/train_train.p'
train_val_file = train_path + 'preprocess_end_complete/train_val.p'
    ...
    for f_idx, file in enumerate(train_set):
        ...
        with open(file) as f:
            ...
            for i in tqdm(range(num_scene)):
                ...
                if 119 not in agent_steps:
                        continue                
                for agent_current_step in range(59, agent_steps[-1]):
